...
#hep_markes = total_cell_markers$Hepatocytes$rnorvegicus_homolog_associated_gene_name[total_cell_markers$Hepatocytes$symbol %in%  Hepatocytes_cl]
...
#if(sample_name %in% c('', 'rat_Lew_02', )) 
