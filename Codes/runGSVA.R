...
f1 = 'Results/new_samples/pathway_analysis/cluster_average_exp_merged_new_samples.txt'
...
set1_heps <- c("0" , "1", "2", "4", "6", "8", "12", "15", "16")
set2_heps <- c('0', '1', '2', '9', '14', '15')

### selecting the Hep clusters
datau <- datau[,paste0('cluster_',set2_heps)] #set2_heps
...
dir = "Results/new_samples/pathway_analysis/gsva_result/"
